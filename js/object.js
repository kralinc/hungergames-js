...
class ItemUtil {
    ...
    static ITEM_MASTERLIST = {
        ...
        'weapon': [
            ...
            [{name: 'trident', strength: 5}, 1],
            [{name: 'pike', strength: 4}, 1],
            [{name: 'gladius', strength: 2.7}, 1],
            [{name: 'a broadsword', strength: 3}, 1],
            [{name: 'a katana', strength: 3.25}, 0.5],
            ...
            [{name: 'a hunting knife', strength: 1.25}, 1.1],
            [{name: 'a steak knife', strength: 0.8}, 1.1],
            [{name: 'a dagger', strength: 1}, 1.1],
            [{name: 'a sharp stick', strength: 0.75}, 1.1],
            [{name: 'a sharp rock', strength: 0.5}, 1],
            [{name: 'a Browning Citori 725 Trap Max Black/Silver/Walnut 12 Gauge 2-3/4in Over Under Shotgun - 32in', strength: 10}, 0.1],
        ]
    };
}
